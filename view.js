...
window.onload = function init()
{
    ...
    // cube = new Cube(gl);
    sphere = new Sphere(gl, 16, 8);//16, 8
    ...
    canvas.addEventListener("mousedown", function (e) {
        ...
        // EXERCISE 8A:
        // Calculate near and far point corresponding to windowPress in
        // clip coordinates.
        // Calculate in world coordinates.
        // Call body.closestHit and set closestHit above.
        // Print out closestHit.  It should be null if you are clicking
        // off the robot.
    ...
    canvas.addEventListener("mousemove", function (e) {
        ...
        if (closestHit == null) {
            ...
            // EXERCISE 8B
            body.child2parent = Mat.translation(translation);
            body.parent2child = Mat.translation(translation.minus());
